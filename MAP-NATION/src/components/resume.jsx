  ...
  useEffect(() => {
    const fetchRoadmaps = async () => {
      try {
        ...
        // console.log('Response Data:', data[0]); // Log the response data to console
        let formatedData = JSON.parse(data[0].roadmapData);
        console.log("format",formatedData);
        setRoadmaps(formatedData|| []); // Ensure we set the correct data
      } catch (error) {
        console.log(error)
